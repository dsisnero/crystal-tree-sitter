...
lib LibTreeSitter
  ...
  fun ts_node_child_by_field_id(self : TSNode, field_id : UInt16) : TSNode
  ...
  fun ts_node_next_named_sibling(TSNode) : TSNode
  fun ts_node_prev_named_sibling(TSNode) : TSNode
  ...
  fun ts_language_supertypes(self : TSLanguage*, length : LibC::UInt32T*) : TSSymbol*

  fun ts_language_subtypes(self : TSLanguage*, supertype : UInt16, length : LibC::UInt32T*) : TSSymbol*
  ...
  fun ts_language_abi_version(TSLanguage*) : LibC::UInt32T
  ...
  fun ts_lookahead_iterator_new(self : TSLanguage*, state : UInt16) : TSLookaheadIterator*
  ...
  # otherwise.
  fun ts_lookahead_iterator_reset_state(self : TSLookaheadIterator*, state : UInt16) : Bool
  ...
  fun ts_lookahead_iterator_reset(
    self : TSLookaheadIterator*, language : TSLanguage*, state : UInt16,
  ) : Bool
